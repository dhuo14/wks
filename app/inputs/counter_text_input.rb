class CounterTextInput < SimpleForm::Inputs::TextInput
	...
	def input
		my_input_html_options = { class: 'form-control char-counter', 'style' => 'margin-bottom:10px;', rows: '2', 'data-char-allowed' => options[:allow_length], 'data-char-warning' => options[:warning_length], 'data-rule-maxlength' => options[:allow_length], 'data-rule-required' => options[:required] }
